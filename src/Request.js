...
const requests = {
  fetchTrendingAll: `https://api.themoviedb.org/3/trending/all/week?api_key=${API_KEY}&language=fr-fr`,
  fetchTrendingMovie: `https://api.themoviedb.org/3/trending/movie/week?api_key=${API_KEY}&language=fr-fr`,
  fetchTrendingTv: `https://api.themoviedb.org/3/trending/tv/week?api_key=${API_KEY}&language=fr-fr`,
...
export const getTeaserLink = async (movieId, mediaType) => {
  const teaserUrl = `https://api.themoviedb.org/3/${mediaType}/${movieId}/videos?api_key=${API_KEY}&language=fr-fr`;
